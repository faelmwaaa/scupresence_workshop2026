    ...
    <div class="page-container bg-gray-50 pb-24">
        <div class="bg-gradient-to-b from-[#5B2163] to-purple-700 px-4 pt-14 pb-20 text-white text-center">
            <div class="relative inline-block">
                ...
                <label class="absolute bottom-0 right-0 bg-white text-[#5B2163] rounded-full p-1.5 cursor-pointer shadow-md">
            ...
            <p class="text-purple-200 text-sm">Pengurus • {{ user.nim }}</p>
            <span :class="['mt-2 inline-block px-3 py-1 rounded-full text-xs font-medium', user.account_status === 'active' ? 'bg-green-400/20 text-green-200' : 'bg-yellow-400/20 text-yellow-200']">
        ...
        <div class="px-4 -mt-8 space-y-4">
            <div class="card">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between"><span class="text-gray-500">NIM</span><span class="font-medium text-gray-800">{{ user.nim || '-' }}</span></div>
                    ...
                    <div class="flex justify-between"><span class="text-gray-500">Fakultas</span><span class="font-medium text-gray-800 text-right max-w-[60%]">{{ user.fakultas || '-' }}</span></div>
                </div>
            </div>
